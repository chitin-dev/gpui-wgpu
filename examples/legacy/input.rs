...
use gpui::{
  ...
  ShapedLine, SharedString, Style, TextColor, TextRun, UTF16Selection, UnderlineStyle, Window,
  WindowBounds, WindowOptions, actions, black, div, fill, hsla, opaque_grey, point, prelude::*, px,
...
impl Element for TextElement {
  ...
  fn prepaint(
    ...
    let run = TextRun {
      ...
      font: style.font(),
      letter_spacing: Some(ordered_float::OrderedFloat(0.1)),
      color: text_color,
