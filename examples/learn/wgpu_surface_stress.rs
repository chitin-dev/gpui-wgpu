...
use gpui::{
  App, Application, Context, Render, WgpuSurfaceHandle, Window, WindowOptions, div, prelude::*, px,
  rgb, rgba, wgpu_surface,
};
use std::sync::Arc;
...
impl CubeRenderState {
  ...
  fn render(&mut self, view: &wgpu::TextureView) {
    ...
    let proj =
      glam::camera::rh::proj::directx::perspective(std::f32::consts::FRAC_PI_4, aspect, 0.1, 100.0);
