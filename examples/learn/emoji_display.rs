  ...
  fn render(&mut self, _window: &mut Window, _cx: &mut Context<Self>) -> impl IntoElement {
    div()
      ...
      .child(
        div()
          .text_base()
          .child("ASCII text: The quick brown fox jumps over the lazy dog 0123456789"),
      )
      .child(
        div()
          .text_base()
      ...
      .child(
        div()
          .text_lg()
          .child("Variation selectors: ✌︎ ✌️ ✊︎ ✊️ ☺︎ ☺️ ❤️ ❤"),
      )
      .child(
        div()
          .text_lg()
          .child("Keycaps + misc: 0️⃣ 1️⃣ 2️⃣ #️⃣ *️⃣ ™️ ©️ ®️ ⚠️"),
      )
      .child(
        div()
          .mt_2()
