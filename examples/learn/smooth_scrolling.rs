use gpui::{
  App, Application, Bounds, Context, MouseButton, Render, ScrollStrategy, UniformListScrollHandle,
  Window, WindowBounds, WindowOptions, div, prelude::*, px, rgb, rgba, size, uniform_list,
};
